...
use SocialLibrary\ReadableMedia\MangaBundle\Tests\TestSerie;
...
class MangaControllerTest extends WebTestCase
{
    ...
    public function testAddMangaWithoutErrors($serie, $volume, $name, $author, $illustrator, $language, $isbn10, $isbn13)
    {
        ...
        $form = $this->crawler->selectButton('Add to my library')->form(array(
            'sociallibrary_readablemedia_mangabundle_mangatype[name]' => $name,
            'sociallibrary_readablemedia_mangabundle_mangatype[volume]' => $volume,
            'sociallibrary_readablemedia_mangabundle_mangatype[serie]' => $respSerie->getId(),
            'sociallibrary_readablemedia_mangabundle_mangatype[creators]' => $respAuthor->getId(),
            'sociallibrary_readablemedia_mangabundle_mangatype[illustrators]' => $respIllustrator->getId(),
            'sociallibrary_readablemedia_mangabundle_mangatype[language]' => $language,
            'sociallibrary_readablemedia_mangabundle_mangatype[isbn10]' => $isbn10,
            'sociallibrary_readablemedia_mangabundle_mangatype[isbn13]' => $isbn13,
        ));
