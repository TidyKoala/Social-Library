...
use SocialLibrary\ReadableMedia\NovelBundle\Form\Type\NovelType;
...
class NovelController extends Controller
{
    ...
    public function indexAction($view, $selection)
    {
        ...
        $entities = $this->getDoctrine()
            ->getRepository('SocialLibraryReadableMediaNovelBundle:Novel')
            ->findAllPaginated(
        ...
        return $this->render(
            'SocialLibraryReadableMediaNovelBundle:Novel:' . $view . '.html.twig',
            array(
                'entities' => $entities,
                'selection' => $selection
            )
     ...
     *
     * @Template("SocialLibraryReadableMediaNovelBundle:Novel:new.html.twig")
     */
     ...
     *
     * @Template("SocialLibraryReadableMediaNovelBundle:Novel:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        $entity = $em->getRepository('SocialLibraryReadableMediaNovelBundle:Novel')->find($id);
