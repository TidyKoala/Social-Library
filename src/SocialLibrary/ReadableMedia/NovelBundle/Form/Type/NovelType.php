...
namespace SocialLibrary\ReadableMedia\NovelBundle\Form\Type;
...
class NovelType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('serie', 'entity', array(
                    ...
                    'class' => 'SocialLibrary\ReadableMedia\NovelBundle\Entity\Serie',
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'SocialLibrary\ReadableMedia\NovelBundle\Entity\Novel'
        ));
    }

    public function getName()
    {
        return 'sociallibrary_readablemedia_novelbundle_noveltype';
    }
}
